...
Added a Digital Recreation rule requiring each section to conclude with an **Answers** subsection that consolidates all publisher-provided answers for that section without adding new solutions or explanations.
